...
#
# "But when you do arithmetic with integers, you'll get integer answers. When your computer can't get the "right" answer, it always rounds down." When you tell Ruby to use decimal places, it returns answers that use decimal places.
#
...
#
#
# Work with your pair and try to write code that displays answers to these questions.
#
